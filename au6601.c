/*
 * Copyright (C) 2018 Joshua Logan.
 *
 * Authors: Joshua Logan <joshua.logan@eveco.re>
...
#define REG_05  0x05 /* ADMA block count? AU6621 only. */
#define REG_0C	0x0c /* ADMA ctrl? AU6621 only. */
#define REG_10	0x10 /* ADMA phy address. AU6621 only. */
#define REG_51	0x51 /* LED ctrl? */
#define REG_52	0x52 /* ??? */
#define REG_61	0x61 /* LED related? Always toggled BIT0 */
#define REG_63	0x63 /* Same as REG_61? */
#define REG_69	0x69 /* ??? */
#define REG_70	0x70 /* Some power related reg, used together with REG_7A */
#define REG_74  0x74 /* ??? */
#define REG_75	0x75 /* ??? */
#define REG_76	0x76 /* Card slot state? */
#define REG_77	0x77 /* ??? */
#define REG_7A	0x7a /* See REG_70 */
#define REG_7B	0x7b /* ??? Padding? Timing? */
#define REG_7C	0x7c /* ??? Padding? Timing? */
#define REG_7D	0x7d /* ??? Padding? Timing? */
#define REG_7F	0x7f /* read EEPROM? */
#define REG_83	0x83
#define REG_85	0x85
#define REG_86	0x86 /* ??? */
#define REG_A1	0xa1 /* ??? */
...
struct au6601_host {
    ...
    /*
    * Trigger Data after Command.
    * In some cases data register
    * should be triggered after
    * command was done
    */
	unsigned int trigger_dma_dac:1;
...
static void au6601_cmd_irq(struct au6601_host *host, u32 intmask)
{
	...
	*       feature so there may be some problems with older
	*       controllers.
	*/
...
static void au6601_timeout_timer(struct timer_list *data)
{
	struct au6601_host *host;
...
MODULE_AUTHOR("Joshua Logan <joshua.logan@eveco.re>");
